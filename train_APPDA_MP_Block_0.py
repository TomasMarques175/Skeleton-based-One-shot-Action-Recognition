...
if __name__ == "__main__":
    ...
    static_params = {
        ...
        "old_model_input_feature_size": 423, # Set to the number of input features that entered in the old model (e.g., 423 for Kinect, 394 for MP, 124 for upper body MP)
