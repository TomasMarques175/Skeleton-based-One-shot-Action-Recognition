...
if __name__ == "__main__":
    ...
    static_params = {
        ...
        "model_name": "Models_Kinect_APPDA_Classifier",
        ...
        "pretrained_model_path": "./pretrained_models_Pytorch/Models_Kinect_APPDA_Classifier",  # Path to the pre-trained model for Therapies dataset in Pytorch format
