...
print('{} |||  '.format('One-shot         (m = 1)') + ' || '.join([ '{} ( {:.2f}): P {:.3f} | R {:.3f} | F1 {:.3f} '.format(metric, one_shot_params[metric]['metric_thr'][metric]['med'], one_shot_res[metric][metric]['precision'], one_shot_res[metric][metric]['recall'], one_shot_res[metric][metric]['f1']) for metric in metrics ]))
print('{} |||  '.format('Few-shot         (m = 3)') + ' || '.join([ '{} ( {:.2f}): P {:.3f} | R {:.3f} | F1 {:.3f} '.format(metric, few_shot_params[metric]['metric_thr'][metric]['med'], few_shot_res[metric][metric]['precision'], few_shot_res[metric][metric]['recall'], few_shot_res[metric][metric]['f1']) for metric in metrics ]))
print('{} |||  '.format('Dynamic few-shot (m = 3)') + ' || '.join([ '{} (<{:.2f}): P {:.3f} | R {:.3f} | F1 {:.3f} '.format(metric, few_shot_params[metric]['metric_thr'][metric]['med'], few_shot_dyn_res[metric][metric]['precision'], few_shot_dyn_res[metric][metric]['recall'], few_shot_dyn_res[metric][metric]['f1']) for metric in metrics ]))
