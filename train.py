...
if __name__ == "__main__":
    ...
    static_params = {
        ...
        "model_name": "Models_Therapist_Classifier_Block_5_4_3_2",
        ...
        "pretrained_model_path": "./pretrained_models_Pytorch/Models_Therapist_Classifier_Block_5_4_3",  # Path to the pre-trained model for Therapies dataset in Pytorch format
