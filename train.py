...
if __name__ == "__main__":
    ...
    static_params = {
        ...
        "model_name": "Models_MP_Classifier_Block_0_1_2_3(k_fold_separated_c_th_comp_NEW_after_MP_Therapist_APPDA)",  # Name of the model for saving and loading
        ...
        "pretrained_model_path": "./pretrained_models_Pytorch/Models_MP_Classifier_Block_0_1_2(k_fold_separated_c_th_comp_NEW_after_MP_Therapist_APPDA)",
