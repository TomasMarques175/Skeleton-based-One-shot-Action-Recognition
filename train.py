...
if __name__ == "__main__":
    ...
    static_params = {
        ...
        "model_name": "Models_MP_Block_0_1_2_3_4_5(k_fold_separated_c_th_comp_NEW)",
        ...
        "pretrained_model_path": "./pretrained_models_Pytorch/Models_MP_Block_0_1_2_3_4(k_fold_separated_c_th_comp_NEW)",  # Path to the pre-trained model for Therapies dataset in Pytorch format
