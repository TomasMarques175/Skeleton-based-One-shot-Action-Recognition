...
if __name__ == "__main__":
    ...
    static_params = {
        ...
        "model_name": "Models_MP_UB_CADIN_Block_0_1_2_3",
        ...
        "pretrained_model_path": "./pretrained_models_Pytorch/Models_MP_UB_CADIN_Block_0_1_2",  # Path to the pre-trained model for Therapies dataset in Pytorch format
