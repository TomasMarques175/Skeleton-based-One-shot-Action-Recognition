...
if __name__ == "__main__":
    ...
    static_params = {
        ...
        "pretrained_model_path": "./pretrained_models_Pytorch/Models_MP_UB_CADIN_Block_0_1_2_3_4_5",  # Path to the pre-trained model for Therapies dataset in Pytorch format
